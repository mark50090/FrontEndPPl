        ...
        <v-card-text class="pb-0 pt-2">
          <v-row align="center" class=" text-box-deleteform">
              <v-col class="pt-5" cols="12" lg="12" md="12">
                <span class="font-head-deleteform">{{textLangDeleteForm.delete_form1}} {{templateform_name}} {{textLangDeleteForm.delete_form2}} </span>
              </v-col>
          </v-row>
        </v-card-text>
          ...
          <v-row align="center" class="text-box-deleteform">
           ...
           <v-col align-self="center" class=" pr-1 pl-0" cols="4" lg="4" md="4">
                <v-btn block color="#757575" dark depressed @click="dialog = false" class="font-send-deleteform">
                    {{ textLangDeleteForm.cancel_delete}}
                </v-btn>
           </v-col>
           <v-col align-self="center" class="pr-0 pl-1" cols="4" lg="4" md="4">
                <v-btn block color="#67C25D" dark depressed class="font-send-deleteform" @click="deleteForm">
                    {{ textLangDeleteForm.confirm_delete }}
                </v-btn>
            </v-col>
            <v-spacer></v-spacer>
          </v-row>
      ...
      async deleteForm(){
        try {
          ...
          this.$swal({
              ...
              text: this.textLangDeleteForm.delete_success,
            ...
            this.$swal({
              ...
              text: this.textLangDeleteForm.delete_fail,
              showCloseButton: true,
              showConfirmButton: false,
              timer: 5000,
              customClass: {
