        ...
        <v-card-text class="pt-3">
          <v-row class="text-box">
            ...
            <v-col class="pb-1 px-0 pt-0" cols="8" lg="8" md="8" :key="item.key">
              <v-text-field
              class="front-box"
                :placeholder="textLang.recipient_email"
                outlined
                dense
                hide-details
                color="#67C25D"
        ...
        try {
          ...
          if(data.message){
            this.$swal({
              ...
              position: 'bottom-end',
              width: '330px',
              title: '<svg style="width:24px;height:24px" class="alert-icon" viewBox="0 0 24 24"><path fill="#67C25D" d="M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22 22 17.5 22 12 17.5 2 12 2M10 17L5 12L6.41 10.59L10 14.17L17.59 6.58L19 8L10 17Z" /></svg><strong class="alert-title">' + this.textLang.send_email_succeed + '</strong>',
              text: this.textLang.send_email_success,
